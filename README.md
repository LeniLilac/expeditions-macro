...
- Offers opt-in **advanced manual recordings** for complete prestart-to-gameplay keyboard, mouse, and wheel sequences, with exact-timeline playback and a 10 ms drift safety limit.
...
6. Every committed change saves automatically. Wait for **All changes saved**, then use **Test playback** to prepare the Fast pose and replay the points through the production input path.
