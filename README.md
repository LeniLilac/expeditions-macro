...
- Saves prioritized Macro plans that can rotate Challenge, Expedition, Story, Raid, supported Event, and interval-based resource-refuel Utility routes while preserving progress between launches.
