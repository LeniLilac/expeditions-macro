...
public partial class ChallengesPage : UserControl, IAppPage
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (PlayMenuBindingException error)
        {
            ...
            {
                StatusText.Text = "Toggle Play Menu key is required. Scroll down to Controls on the Dashboard.";
        ...
        CancellationToken cancellationToken)
    {
        ...
        await Dispatcher.InvokeAsync(() =>
        {
            StatusText.Text = "Camera task skipped. Capturing configured diagnostics before continuing.";
