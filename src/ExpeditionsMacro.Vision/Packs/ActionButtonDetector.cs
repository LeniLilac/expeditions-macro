...
internal static class ActionButtonDetector
{
    ...
    {
        // Map 2 foliage can form a 105x40 green component in this search area.
        // The reviewed live action remains at least 100 pixels wide and no more
        // than 36 pixels tall, including the supported scaled layouts.
        ["map_select"] = new(new ScreenRegion(590, 455, 218, 135), ButtonColor.Green, 728, 535, 130, 90, 100, 150, 17, 36, 0.42),
        ["select_stage"] = new(new ScreenRegion(590, 455, 218, 135), ButtonColor.Green, 728, 535, 130, 90, 100, 150, 17, 36, 0.42),
        ...
        // The Story party panel settles 27 pixels above the Raid layout after its
        // entrance animation. Keep a second exact three-button rail instead of
        // making each individual action broadly position-tolerant.
        ...
        // Roblox can vertically compact the equipment dialog when the team panel
        // uses its narrower layout. Search both reviewed rails, then click the
        // matched component instead of assuming the original lower position.
        ["team_equipment_include"] = new(new ScreenRegion(250, 305, 145, 110), ButtonColor.Green, 322, 359, 60, 55, 60, 105, 18, 42, 0.34),
        ["team_equipment_exclude"] = new(new ScreenRegion(345, 305, 145, 110), ButtonColor.Red, 405, 359, 60, 55, 60, 105, 18, 42, 0.30),
    };
