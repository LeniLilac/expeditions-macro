...
The production rewrite separates reusable automation behavior from the WPF shell:
...
- `ExpeditionsMacro.DatasetBuilder` compiles private raw captures into a small, hashed detector pack.
