...
- Protected by: `PlacementAuthoringTests`, `FastNoAlignPreparationSessionTests`, preset validation tests, runner compatibility checks, and both-theme Placement Models snapshots.
