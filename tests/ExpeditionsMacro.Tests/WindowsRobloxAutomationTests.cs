...
public sealed class WindowsRobloxAutomationTests
{
    ...
    [InlineData(192u, 200)]
    [InlineData(106u, 110)]
    public void DisplayScalePercentageUsesEffectiveMonitorDpi(
        uint dpi,
        int expectedPercentage)
    {
        Assert.Equal(
            expectedPercentage,
            WindowsRobloxDisplayScale.ScalePercentageFromDpi(dpi));
    }

    [Fact]
    public void DisplayScaleFailureExplainsTheRequiredUserAction()
    {
    ...
    [Fact]
    public void PinnedWindowReleasePolicy_PageOrScrollAutoDetachUsesNonActivatingMinimize()
    {
        Assert.Equal(
            7,
    ...
    [Fact]
    public void PinnedWindowReleasePolicy_ManualUnpinAndShutdownRestoreWithoutMinimizing()
    {
        Assert.Equal(
            9,
            WindowsPinnedWindowRelease
    ...
    [Fact]
    public void PinnedWindowReleasePolicy_OcclusionAndModalSuspendWithoutShowingOrActivating()
    {
        Assert.Null(
            WindowsPinnedWindowRelease
                .ResolveShowCommand(
