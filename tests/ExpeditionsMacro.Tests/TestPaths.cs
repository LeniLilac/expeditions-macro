...
internal static class TestPaths
{
    ...
    public static string RefuelDatasets => Path.Combine(
        RepositoryRoot,
        "datasets",
        "anime-expeditions",
        "refuel");

    public static string SettingsDatasets => Path.Combine(
        RepositoryRoot,
        "datasets",
        "anime-expeditions",
        "settings");

    public static string EventDatasets => Path.Combine(
        RepositoryRoot,
        "datasets",
        "anime-expeditions",
        "events");

    public static string BountyDatasets => Path.Combine(
        RepositoryRoot,
        "datasets",
        "anime-expeditions",
        "bounties");
